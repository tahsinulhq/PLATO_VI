...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2021 at 09:41 PM
...
--
ALTER TABLE `co_t`
  ADD CONSTRAINT `FK_CourseCO` FOREIGN KEY (`CourseID`) REFERENCES `course_t` (`CourseID`),
  ADD CONSTRAINT `FK_PLOCO` FOREIGN KEY (`PLOID`) REFERENCES `plo_t` (`PLOID`);
...
--
ALTER TABLE `employee_t`
  ADD CONSTRAINT `FK_PersonEmployee` FOREIGN KEY (`PersonID`) REFERENCES `person_t` (`PersonID`);

--
-- Constraints for table `higer_authority_t`
--
ALTER TABLE `higer_authority_t`
  ADD CONSTRAINT `FK_UniversityAuthority` FOREIGN KEY (`UniversityID`) REFERENCES `university_t` (`UniversityID`);

--
-- Constraints for table `instructor_t`
--
ALTER TABLE `instructor_t`
  ADD CONSTRAINT `FK_DepartmentInstructor` FOREIGN KEY (`DepartmentID`) REFERENCES `department_t` (`DepartmentID`),
  ADD CONSTRAINT `FK_PersonInstructor` FOREIGN KEY (`PersonID`) REFERENCES `person_t` (`PersonID`);

--
-- Constraints for table `plo_t`
--
ALTER TABLE `plo_t`
  ADD CONSTRAINT `FK_ProgramPLO` FOREIGN KEY (`ProgramID`) REFERENCES `program_t` (`ProgramID`);

--
-- Constraints for table `program_t`
--
ALTER TABLE `program_t`
  ADD CONSTRAINT `FK_DepartmentProgram` FOREIGN KEY (`DepartmentID`) REFERENCES `department_t` (`DepartmentID`);

--
-- Constraints for table `school_t`
--
ALTER TABLE `school_t`
  ADD CONSTRAINT `FK_UniversitySchool` FOREIGN KEY (`UniversityID`) REFERENCES `university_t` (`UniversityID`);

--
-- Constraints for table `section_t`
--
ALTER TABLE `section_t`
  ADD CONSTRAINT `FK_CourseSection` FOREIGN KEY (`CourseID`) REFERENCES `course_t` (`CourseID`),
  ADD CONSTRAINT `FK_InstructorSection` FOREIGN KEY (`InstructorID`) REFERENCES `instructor_t` (`InstructorID`);

--
-- Constraints for table `student_t`
--
ALTER TABLE `student_t`
  ADD CONSTRAINT `FK_AssessmentStudent` FOREIGN KEY (`AssessmentID`) REFERENCES `assessment_t` (`AssessmentID`),
  ADD CONSTRAINT `FK_ProgramStudent` FOREIGN KEY (`ProgramID`) REFERENCES `program_t` (`ProgramID`),
  ADD CONSTRAINT `STUDENT_FK1` FOREIGN KEY (`PersonID`) REFERENCES `person_t` (`PersonID`);
COMMIT;
